    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Center(child: Container(
          ...
          width: 36, height: 4,
          decoration: BoxDecoration(
              color: Get.theme.colorScheme.onSurface.withValues(alpha: 0.24), borderRadius: BorderRadius.circular(2)),
        )),
        const SizedBox(height: 16),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: Row(children: [
            Icon(FluentIcons.arrow_sort_20_filled, color: Get.theme.colorScheme.onSurface.withValues(alpha: 0.54), size: 16),
            const SizedBox(width: 8),
            Text('Ordina per', style: TextStyle(
                color: Get.theme.colorScheme.onSurface.withValues(alpha: 0.54), fontSize: 13,
        ...
        child: Row(children: [
          Container(
            ...
            child: Icon(icon, size: 18,
                color: sel ? const Color(0xFF0A84FF) : Get.theme.colorScheme.onSurface.withValues(alpha: 0.54)),
          ),
          const SizedBox(width: 14),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(label, style: TextStyle(
                color: sel ? Get.theme.colorScheme.onSurface : Get.theme.colorScheme.onSurface.withValues(alpha: 0.7),
                fontSize: 14, fontWeight: FontWeight.w600)),
            Text(sub, style: TextStyle(color: Get.theme.colorScheme.onSurface.withValues(alpha: 0.38), fontSize: 11)),
          ])),
